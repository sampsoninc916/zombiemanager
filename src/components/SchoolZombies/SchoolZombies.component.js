...
class SchoolZombies extends Component {
  state = {
    data: null,
  ...
  componentDidMount() {
    ...
    this.getSchoolZombies()
          .then(res => this.setState({ data: res }))
          .catch(err => console.log(err));
  }

  getSchoolZombies = async () => {
    const response = await fetch('/api/schoolzombies');
