...
class WarehouseZombies extends Component {
  state = {
    data: null,
  ...
  componentDidMount() {
    ...
    this.getWarehouseZombies()
        .then(res => this.setState({ data: res }))
        .catch(err => console.log(err));
  }

  getWarehouseZombies = async () => {
    const response = await fetch('/api/warehousezombies');
...
export default WarehouseZombies;